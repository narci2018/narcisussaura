      ...
      <div className="space-y-6">
        ...
        <div className="flex items-center justify-between pb-4 border-b border-[#1f2433]">
          <div>
            ...
            <p className="text-[13px] text-gray-500">Configure networking, proxy modes, and system integration</p>
          </div>
          <button
            onClick={handleSave}
        ...
        <div className="bg-[#12151f] border border-[#212637] rounded-2xl p-5 space-y-4">
          <div className="flex items-center gap-2 text-[13px] font-semibold text-gray-200">
            ...
            {[
              ...
              return (
                ...
                >
                  ...
                  <div className="text-[12px] text-gray-400 leading-relaxed">{mode.desc}</div>
                </div>
              );
            })}
          </div>
          ...
          <div className="grid grid-cols-1 gap-4">
            <div>
              ...
              <input
                ...
                className="w-full bg-[#0b0d14] border border-[#212638] rounded-xl px-3 py-2 text-[13px] text-gray-200 font-mono focus:outline-none focus:border-blue-500/60"
              />
            </div>
        ...
        <div className="bg-[#12151f] border border-[#212637] rounded-2xl p-5 space-y-4">
            ...
            {[
              ...
              return (
                ...
                >
                  ...
                  <div className="text-[12px] text-gray-400 leading-relaxed">{route.desc}</div>
                </div>
              );
            })}
          </div>
          ...
          <div className="flex items-center justify-between py-2 border-t border-[#1c202d] pt-3">
            <div>
              <div className="text-[13px] font-medium text-gray-200">Bypass Mainland China & Private LAN</div>
              <div className="text-[12px] text-gray-500">Directly connect using GeoSite / GeoIP rulesets (geosite:cn, geoip:cn, private LAN)</div>
            </div>
            <button
          ...
          <div className="flex items-center justify-between py-2 border-t border-[#1c202d] pt-3">
            <div>
              <div className="flex items-center gap-2">
                <span className="text-[13px] font-medium text-gray-200">IPv6 Network Support (IPv6 支持)</span>
                <span className={`text-[12px] px-1.5 py-0.2 rounded font-mono ${
          ...
          <div className="flex items-center justify-between py-2 border-t border-[#1c202d] pt-3">
            <div>
              <div className="flex items-center gap-2">
                <span className="text-[13px] font-medium text-gray-200">阻断 UDP 443 (Block QUIC / HTTP3)</span>
                <span className={`text-[12px] px-1.5 py-0.2 rounded font-mono ${
        ...
        <div className="bg-[#12151f] border border-[#212637] rounded-2xl p-5 space-y-4">
          ...
          <div className="bg-[#0b0d14] border border-[#212638] rounded-xl p-4 flex flex-col justify-between gap-3">
            <div className="space-y-1">
              <div className="text-[12px] text-gray-400 font-medium">当前启用的规则集</div>
              <div className="flex items-center gap-2">
                <select
                  value={formData.active_rule_set_id || 'default'}
                  onChange={(e) => handleSelectRuleSet(e.target.value)}
                  className="bg-[#141824] border border-[#2d354d] text-gray-100 text-[13px] rounded-lg px-3 py-1.5 font-medium focus:outline-none focus:border-cyan-500 min-w-[160px]"
                >
                  {ruleSets.map((s) => (
                ...
                <span className="text-[12px] text-emerald-400 bg-emerald-500/10 border border-emerald-500/20 px-2 py-0.5 rounded-md">
                  生效中
                </span>
              </div>
            </div>

            <div className="flex items-center gap-4 text-[13px] font-mono text-gray-400 bg-[#12151f] px-3.5 py-2 rounded-lg border border-[#1f2436]">
              <div>
                <span className="text-gray-500 text-[12px] block">直连规则</span>
                <span className="text-emerald-400 font-semibold">{activeRuleSet.direct_rules?.length || 0}</span>
              </div>
              <div className="w-[1px] h-6 bg-[#212638]" />
              <div>
                <span className="text-gray-500 text-[12px] block">代理规则</span>
                <span className="text-sky-400 font-semibold">{activeRuleSet.proxy_rules?.length || 0}</span>
              </div>
              <div className="w-[1px] h-6 bg-[#212638]" />
              <div>
                <span className="text-gray-500 text-[12px] block">广告拦截</span>
        ...
        <div className="bg-[#12151f] border border-[#212637] rounded-2xl p-5 space-y-4">
          ...
          <div className="flex items-center justify-between py-2 border-b border-[#1c202d]">
            <div>
              <div className="text-[13px] font-medium text-gray-200">Kill Switch</div>
              <div className="text-[12px] text-gray-500">Block internet traffic if connection drops unexpectedly</div>
            </div>
            <button
          ...
          <div className="flex items-center justify-between py-2">
            <div>
              <div className="text-[13px] font-medium text-gray-200">Remote DNS Resolution</div>
              <div className="text-[12px] text-gray-500">Encrypted DNS over HTTPS / TLS to prevent DNS Leaks</div>
            </div>
            <select
              value={formData.dns_mode}
              onChange={(e) => setFormData({ ...formData, dns_mode: e.target.value })}
              className="bg-[#0b0d14] border border-[#212638] rounded-xl px-3 py-1.5 text-[13px] text-gray-200 focus:outline-none focus:border-blue-500/60"
            >
        ...
        {/* Core details footer */}
        <div className="text-center py-2 text-[12px] text-gray-600 font-mono">
          ...
          <div className="bg-[#12151f] border border-[#2d354d] rounded-2xl w-full max-w-2xl max-h-[90vh] flex flex-col shadow-2xl overflow-hidden animate-in fade-in duration-200">
            ...
            <div className="p-6 overflow-y-auto space-y-4 flex-1">
              ...
              <div className="flex flex-wrap items-center justify-between gap-2 p-2.5 bg-[#0b0d14] rounded-xl border border-[#212638]">
                <div className="flex items-center gap-2">
                  <span className="text-[12px] text-gray-400">切换规则集:</span>
                  <select
                    ...
                    className="bg-[#141824] border border-[#2d354d] text-gray-200 text-[13px] rounded-lg px-2.5 py-1"
                  >
                    {ruleSets.map((s) => (
                      <option key={s.id} value={s.id}>
                        {s.name} {s.id === 'default' ? '(默认)' : ''}
              ...
              {/* Rule Set Name */}
              <div>
                <label className="text-[12px] font-medium text-gray-300 block mb-1">
                  规则集名称
                </label>
                <input
                  type="text"
                  ...
                  className="w-full bg-[#0b0d14] border border-[#212638] rounded-xl px-3 py-2 text-[13px] text-gray-200 focus:outline-none focus:border-cyan-500"
                />
              </div>
              ...
              <div>
                <div className="flex items-center justify-between mb-1">
                  <label className="text-[12px] font-medium text-emerald-400">
                    国内与局域网直连规则 (Direct)
                  </label>
                ...
                <textarea
                  ...
                  className="w-full bg-[#0b0d14] border border-[#212638] rounded-xl px-3 py-2 text-[13px] text-emerald-300 font-mono focus:outline-none focus:border-emerald-500/60 leading-relaxed"
                />
              </div>
              ...
              <div>
                <div className="flex items-center justify-between mb-1">
                  <label className="text-[12px] font-medium text-sky-400">
                ...
                <textarea
                  ...
                  className="w-full bg-[#0b0d14] border border-[#212638] rounded-xl px-3 py-2 text-[13px] text-sky-300 font-mono focus:outline-none focus:border-sky-500/60 leading-relaxed"
                />
              </div>
              ...
              <div>
                <div className="flex items-center justify-between mb-1">
                  <label className="text-[12px] font-medium text-rose-400">
                ...
                <textarea
                  ...
                  className="w-full bg-[#0b0d14] border border-[#212638] rounded-xl px-3 py-2 text-[13px] text-rose-300 font-mono focus:outline-none focus:border-rose-500/60 leading-relaxed"
                />
              </div>
            </div>
