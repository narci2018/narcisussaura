...
export const ResidentialView: React.FC = () => {
  ...
  // 点"终止"。只认 connecting —— 连接失败会把状态留在 error,拿它当"忙"就锁死按钮。
                  ...
                  <div className="pt-3 border-t border-[#1c2133] flex items-center justify-between gap-3">
                    ...
                    {isConnected ? (
                      ...
                      <button
                        ...
                        className="px-3.5 py-1.5 bg-amber-600 hover:bg-amber-500 text-white rounded-xl text-xs font-medium transition-all shadow-sm shadow-amber-600/20 flex items-center gap-1.5 active:scale-95 disabled:opacity-40 disabled:hover:bg-amber-600"
